 ...
 * 
 * Disassembly of PTDT.dat, Thu Apr  6 17:23:31 2023
 *
...
[004h 0004 004h]                Table Length : 00000CF0
...
Raw Table Data: Length 3312 (0xCF0)

    0000: 50 54 44 54 F0 0C 00 00 00 B0 41 4C 41 53 4B 41  // PTDT......ALASKA
    0010: 41 20 4D 20 49 20 00 00 05 00 00 00 4D 53 46 54  // A M I ......MSFT
    0020: 0D 00 00 01 00 00 56 00 01 00 00 00 50 00 15 01  // ......V.....P...
    ...
    0080: 00 00 58 10 00 17 00 00 00 00 00 00 00 00 00 00  // ..X.............
    ...
    0230: 00 00 FF FF FF FF FF 00 00 00 00 00 00 00 00 00  // ................
    ...
    0550: 6E 00 74 00 00 00 00 00 5A 00 01 00 00 00 72 00  // n.t.....Z.....r.
    0560: 61 04 00 00 00 00 00 00 00 00 00 00 00 00 00 00  // a...............
    ...
    07B0: 00 00 34 00 00 00 00 00 00 00 00 00 00 00 00 00  // ..4.............
    ...
    0800: 13 0E 01 00 00 00 00 00 00 00 00 00 00 00 00 00  // ................
    ...
    08A0: 4A 00 01 00 00 00 03 00 00 00 0F 00 00 00 00 00  // J...............
    ...
    08F0: 90 06 16 00 0F 00 00 00 00 00 00 00 00 00 00 00  // ................
    ...
    0B50: 00 00 00 00 4C 00 01 00 00 00 00 00 00 FF FF 00  // ....L...........
    ...
    0CA0: 00 00 50 00 01 00 00 00 50 00 37 01 0B 00 00 00  // ..P.....P.7.....
    0CB0: 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00  // ................
    0CC0: 86 BC B0 CC CD 1B 6F 47 AA BE E1 91 59 24 4B FD  // ......oG....Y$K.
    0CD0: 53 00 69 00 6C 00 69 00 63 00 6F 00 6E 00 20 00  // S.i.l.i.c.o.n. .
    0CE0: 56 00 65 00 72 00 73 00 69 00 6F 00 6E 00 00 00  // V.e.r.s.i.o.n...
